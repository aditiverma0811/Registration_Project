...
public class Login extends AppCompatActivity   implements TitlesFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor2.apply();
        //inputs into the shared preference the name of the user and what time they logged in
            ...
            AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Login.this)
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            //adds into the shared preference the title of the note and at what time the user added it
